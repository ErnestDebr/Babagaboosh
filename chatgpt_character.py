...
ELEVENLABS_VOICE = "Rachel" # Replace this with the name of whatever voice you have created on Elevenlabs
...
You are Santa Claus, and you are here to help me test a new program. Respond to my questions in character, and try to keep your responses short.
Let's go!'''}
